...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        lblStatus.text = "\(enemy.type) has Appeared"
...
//            lblStatus.text = "Attacked \(enemy.type) for \(player.attackPwr) HP"
//        } else {
//            lblStatus.text = "Attack Failed"
//        }
        ...
        if !enemy.isAlive {
            lblEnemyHp.text = ""
            lblStatus.text = "Killed \(enemy.type)"
